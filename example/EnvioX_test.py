...
def main():
    ...
    environment_config_random = EnvioX.TG.generate_env_configs(grid_size=grid_size, 
    ...
    robot_positions, robot_yaws = EnvioX.TG.generate_robot_configs(grid_size=grid_size, 
    ...
    environment = EnvioX.TG.generate_environment(env_config=environment_config,
                                                 visualize=False
                                                 )

    # generating point cloud data of a detection area
    terrain_data = EnvioX.TG.filter_points_in_detection_area(environment=environment,
    ...
    coords, feats = EnvioX.TG.voxelize_pc(point_cloud=sensor_detection, # return value of filter_points_in_detection_area() 
    ...
    EnvioX.Visualizer.visualize_pc(terrain_data)
    EnvioX.Visualizer.visualize_pc(sensor_detection)
    EnvioX.Visualizer.visualize_voxel(coords, voxel_resolution)
